...
public class adminaviewdapter extends FirestoreRecyclerAdapter<modelpermission, adminaviewdapter.myviewholder>
{


    public adminaviewdapter(@NonNull FirestoreRecyclerOptions<modelpermission> options) {
        super(options);
    }

    @NonNull
    @Override
    public adminaviewdapter.myviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.singlerow,parent, false);
        return new adminaviewdapter.myviewholder(view);
    }

    @Override
    protected void onBindViewHolder(@NonNull adminaviewdapter.myviewholder holder, int position, @NonNull modelpermission modelpermission) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                activity.getSupportFragmentManager().beginTransaction().replace(R.id.avwrapper,
